...
GPT_MODEL = "gpt-3.5-turbo-0125"  # URL for the GPT model (will be updated to our fine-tuned model in the future)
...
RERANK = False # Whether to rerank the documents (currently bad performance)
